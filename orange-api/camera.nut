...
class OCamera extends OObject {
	...
	x_bounds = 100 // How far the camera goes in front of Tux. Where can i find this value in the source?
	x_speed = 2
	...
	function get_width() return object.get_screen_width()
	function get_height() return object.get_screen_height()
}
